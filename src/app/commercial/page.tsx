          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 ml-auto">
              <span className="text-sm text-gray-500">
                {loading ?  <span className="inline-block h-4 w-28 bg-gray-200 rounded animate-pulse" />  : <><span className="font-bold text-gray-900">{total}</span> propert{total !== 1 ? "ies" : "y"}</>}
              </span>
