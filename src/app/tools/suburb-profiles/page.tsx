      ...
      <main className="min-h-screen bg-gray-50 pt-20">
        ...
        <section className="bg-[#1a1a5e] py-12">
          <div className="max-w-7xl mx-auto px-5 sm:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-2xl">
              ...
              <button className="flex items-center justify-center gap-2 bg-[#16a34a] hover:bg-[#15803d] text-white font-bold px-6 py-3 rounded-xl transition-colors">
                Search
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div key={stat.label} className="bg-white rounded-xl p-5 border border-gray-100 text-center">
                <div className="w-10 h-10 bg-green-50 rounded-lg flex items-center justify-center mx-auto mb-3 text-[#16a34a]">
                  {stat.icon}
                </div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {suburbs.map((suburb) => (
                    <tr key={suburb.name} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-green-50 text-[#16a34a]">
                          {suburb.growth}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-500">{suburb.population}</td>
                      <td className="px-6 py-4">
                        <button className="text-sm text-[#16a34a] font-semibold hover:underline">
                          View Profile →
                        </button>
                      </td>
                    </tr>
        ...
        <section className="bg-[#16a34a] py-12">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 text-center">
            ...
            <button className="bg-white text-[#16a34a] font-black px-8 py-3 rounded-xl hover:bg-green-50 transition-colors">
              Request Report →
            </button>
          </div>
        </section>
