              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#16a34a]"
                  />
                </div>
                ...
                <div>
                  ...
                  <select className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#16a34a]">
                    <option>House</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#16a34a] text-white font-bold py-4 rounded-xl hover:bg-[#15803d] transition-colors flex items-center justify-center gap-2"
                >
                  Get Free Valuation
