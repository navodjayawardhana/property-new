              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <span className="text-lg font-bold text-[#16a34a]">{formatCurrency(loanAmount)}</span>
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <span className="text-lg font-bold text-[#16a34a]">{interestRate}%</span>
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <span className="text-lg font-bold text-[#16a34a]">{loanTerm} years</span>
