...
import { Eye, EyeOff, Mail, Lock, ArrowRight, ShieldCheck, ShieldAlert } from "lucide-react";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "done") {
        ...
        setError("Admin accounts require a verified email.");
      }
    } catch (err: unknown) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <h1 className="text-2xl font-black text-white mb-1 text-center">Admin Portal</h1>
