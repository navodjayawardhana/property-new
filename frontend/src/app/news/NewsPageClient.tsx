...
export default function NewsPageClient() {
  ...
  const [newsAvailable, setNewsAvailable] = useState<boolean | null>(null);
  ...
  useEffect(() => {
    ...
    newsApi
      ...
      .then((res) => {
        ...
        if (activeCategory === "All") setNewsAvailable(res.data.length > 0);
      })
      .catch(() => { setArticles([]); if (activeCategory === "All") setNewsAvailable(false); })
      ...
      <div className="border-b border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <p className="text-gray-500 text-sm mt-1">
            ...
            and housing information and insights.
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-gray-800 text-lg font-bold mb-1">
              {newsAvailable === false ? "News coming soon" : "No articles found"}
            </p>
            <p className="text-gray-400 text-sm max-w-xs mx-auto">
              {newsAvailable === false
                ? "We're working on bringing you the latest property news and insights."
                ...
                {secondary.map((article) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      {article.tag && (
                        <span className="text-xs font-bold text-[#16a34a] uppercase">
                          {article.tag}
                        </span>
                      )}
