    ...
    return (
      <main className="min-h-screen bg-gray-50 pt-24">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 text-center py-20">
          ...
          <Link href="/buy" className="text-[#4CD137] font-semibold mt-4 inline-block">
            ← Back to listings
          </Link>
        </div>
      </main>
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Link href="/buy" className="text-gray-400 hover:text-[#4CD137]">Buy</Link>
            <span className="text-gray-300">/</span>
          ...
          <div className="relative h-[400px] sm:h-[500px]">
            ...
            <div className="absolute top-4 right-4 flex gap-2">
              <button
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${liked ? "bg-[#4CD137]" : "bg-white/90 hover:bg-white"}`}
              >
            ...
            <div className="flex gap-2 p-4 overflow-x-auto">
              {property.images.map((img, idx) => (
                <button
                  ...
                  className={`w-20 h-14 rounded-lg overflow-hidden shrink-0 border-2 transition-colors ${currentImage === idx ? "border-[#4CD137]" : "border-transparent"}`}
                >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <span className="px-3 py-1 rounded-full text-xs font-bold text-white bg-[#1a1a5e]">
                  {property.type}
                </span>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  ...
                  <span className="flex items-center gap-1">
                    <Calendar className="w-4 h-4" /> Listed {property.listedDate}
                  </span>
                </div>
              </div>
            </div>
            ...
            {property.inspectionTimes && (
              <div className="bg-white rounded-2xl p-6 border border-gray-100">
                <h2 className="text-lg font-bold text-gray-900 mb-4">Inspection Times</h2>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 border border-gray-100 sticky top-24">
              ...
              <Link
                ...
                className="block text-center text-sm text-gray-500 hover:text-[#4CD137] mt-4"
              >
                View Agent Profile →
              </Link>
            </div>
